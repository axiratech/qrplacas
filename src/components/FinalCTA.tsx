      ...
      <div className="container mx-auto px-4 relative">
        <div className="mx-auto max-w-3xl text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <Button size="lg" onClick={scrollToPlans} className="group gap-2 bg-gradient-to-r from-secondary to-primary hover:opacity-90 shadow-2xl hover:shadow-primary/50 transition-all text-lg px-10 py-7 relative overflow-hidden">
            ...
            <Button size="lg" onClick={scrollToPlans} variant="outline" className="gap-2 border-2 border-primary text-primary hover:bg-primary hover:text-white transition-all text-lg px-10 py-7">
